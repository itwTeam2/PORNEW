...
{
    public class GSQHeaderController : Controller
    {
            ...
            if (Session["UID"] != null)
            {
                ...
                try
                {
                    ...
                    if (ServiceInfo != null)
                    {
                        ...
                        string CreatePorNo = PorNoCreate(EstablishmentId, geqStatus);
                                    ...
                                    if (checkGsqVacantStatus != 0)
                                    {
                                        ...
                                        else
                                        {
                                            if (ConSNo != 0 && obj_GSQHeader.Location != null && obj_GSQHeader.GSQNo != null && obj_GSQHeader.AllocatedDate != null)
                                            {
                                                ...
                                                objGSQHeader.Location = EstablishmentId;
                                                ...
                                                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew))
                                                {
                                                    if (_db.SaveChanges() > 0)
                                                    {
                                                        ...
                                                        int FMSID = _db.FlowManagementStatus.Where(x => x.EstablishmentId == EstablishmentId && x.UserRoleID == (int)POR.Enum.UserRole.P3CLERK).Select(x => x.FMSID).FirstOrDefault();
                                                        ...
                                                        objNOKChangeHeader.Location = EstablishmentId;
                                                        ...
                                                        if (_db.SaveChanges() > 0)
                                                        {
                                                            ...
                                                            var NOKCHID = _db.NOKChangeHeaders.Where(x => x.Sno == ConSNo &&
                                                                          x.Location == EstablishmentId && x.NOKStatus == NokStatus && x.Active == 1 && x.GSQHeaderID == GSQHID).OrderByDescending(x => x.CreatedDate).Select(x => x.NOKCHID).FirstOrDefault();
                                                            ...
                                                            objNOKChangeDetail.NOKChangeTo = obj_GSQHeader.RelationshipName;
        ...
        [HttpGet]
        public ActionResult IndexAllocateMQ(string sortOrder, string currentFilter, string searchString, int? page, int? RSID)
        {
            ...
            if (UID != 0)
            {
                ...
                if (searchString != null)
                {
                    ...
                    var resultStatus = dt.AsEnumerable().Where(x => x.Field<int>("Active") == 1 && x.Field<int>("RecordStatusID") == 2000 || x.Field<int>("RecordStatusID") == 1000).ToList();

                    if (resultStatus.Count != 0)
                    {
                        dt2 = dt.AsEnumerable().Where(x => x.Field<int>("Active") == 1 && x.Field<int>("RecordStatusID") == 2000 || x.Field<int>("RecordStatusID") == 1000).CopyToDataTable();
                    }
                ...
                switch (RoleId)
                {
                    ...
                    default:
                        ...
                        if (result.Count != 0)
                        {
                            ...
                            {
                                var rows = dt.AsEnumerable().Where(x => x.Field<int>("CurrentStatus") == RoleId && x.Field<int>("RecordStatusID") == (int)POR.Enum.RecordStatus.Forward && x.Field<int>("Active") == 1 && (x.Field<int>("ServiceTypeId") == (int)POR.Enum.ServiceType.RegAirmen ||
                                ...
                                if (rows.Any())
                                {
                                    dt2 = dt.AsEnumerable().Where(x => x.Field<int>("CurrentStatus") == RoleId && x.Field<int>("RecordStatusID") == (int)POR.Enum.RecordStatus.Forward && x.Field<int>("Active") == 1 && (x.Field<int>("ServiceTypeId") == (int)POR.Enum.ServiceType.RegAirmen ||
                            ...
                            else
                            {
                                ...
                                {
                                    var rows = dt.AsEnumerable().Where(x => x.Field<int>("CurrentStatus") == RoleId && 
                                                x.Field<int>("RecordStatusID") == (int)POR.Enum.RecordStatus.Forward && 
                                    ...
                                    if (rows.Any())
                                    {
                                        dt2 = dt.AsEnumerable().Where(x => x.Field<int>("CurrentStatus") == RoleId && x.Field<int>("RecordStatusID") ==
                                             (int)POR.Enum.RecordStatus.Forward && (x.Field<int>("ServiceTypeId") == (int)POR.Enum.ServiceType.VolAirmen ||
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (Count != 0)
                                        {
                                            ...
                                            dt2 = dt.AsEnumerable().Where(x => x.Field<int>("CurrentStatus") == RoleId && x.Field<int>("RecordStatusID") ==
                                             (int)POR.Enum.RecordStatus.Forward && (x.Field<int>("ServiceTypeId") == (int)POR.Enum.ServiceType.RegAirmen ||
                                             x.Field<int>("service_type") == (int)POR.Enum.ServiceType.RegAirWomen || x.Field<int>("ServiceTypeId") == (int)POR.Enum.ServiceType.VolAirmen || x.Field<int>("ServiceTypeId") == (int)POR.Enum.ServiceType.VolAirWomen)).CopyToDataTable();
                                        }
                                    }
        ...
        public string PorNoCreate(string EstablishmentId,int gsqStatus)
        {
            ...
            try
            {
                ...
                int jobcount = _db.GSQHeaders.Where(x => x.Location == EstablishmentId && x.CreatedDate.Value.Month == currentmonth && x.CreatedDate.Value.Year == currentyear).Count();
        ...
        public ActionResult Details(int GSQHID,int Rejectstatus)
        {
            ...
            if (Session["UID"].ToString() != null)
            {
                ...
                var CurrentStatus_UserRole = (from f in _db.FlowStatusGSQDetails
                                              ...
                                              where u.EstablishmentId == EstablishmentId & f.GSQHeaderID == GSQHID
        ...
        public ActionResult Delete(int id)
        {
            ...
            { 
                ...
                return RedirectToAction("IndexAllocateMQ", "GSQHeader");
            }
            catch (Exception ex)
            {
                throw ex;
                ...
                if (Session["UID"] != null)
                {
                    ...
                    using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew))
                    {
                        if (_db.SaveChanges() > 0)
                        {
                            ...
                            objNOKChangeDetail.NOKName = obj_GSQHeader.NOKName;
                            if (obj_GSQHeader.RelationshipName != null)
                            {
                                objNOKChangeDetail.NOKChangeTo = obj_GSQHeader.RelationshipName;
                            }
                            objNOKChangeDetail.NOKAddress = obj_GSQHeader.NOKaddress;
                            ...
                            if (obj_GSQHeader.District != 0)
                            {
                                ...
                                if (obj_GSQHeader.GSName != "SELECT")
                                {
                                    objNOKChangeDetail.GSDivision = obj_GSQHeader.GSName;
                                }
                                if (obj_GSQHeader.PoliceStation1 != "SELECT")
                                {
                                    objNOKChangeDetail.PoliceStation = obj_GSQHeader.PoliceStation1;
                                }
        ...
        public ActionResult PrintData(int GSQHID)
        {
            ...
            var servicerType = _db.GSQHeaders.Where(x => x.GSQHID == GSQHID && x.Active == 1).Select(x => x.ServiceTypeId).FirstOrDefault();
        ...
        //Forward the added GSQ details to next authority
        [HttpGet]
                    ...
                    if (updateStatus == true)
                    {
                        ...
                        using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew))
                        {
                            if (_db.SaveChanges() > 0)
                            {
                                ...
                                scope.Complete();
                                return RedirectToAction("IndexAllocateMQ");
                            }
                            else
                            {
                                scope.Dispose();
            ...
            if (UID != 0)
            {
                ...
                if (resultStatus.Count != 0)
                {
                    dt2 = dt.AsEnumerable().Where(x => x.Field<int>("Active") == 1 && x.Field<int>("RecordStatusID") == (int)POR.Enum.RecordStatus.Reject && 
                          (x.Field<int>("ServiceTypeId") == (int)POR.Enum.ServiceType.RegAirmen || x.Field<int>("ServiceTypeId") == (int)POR.Enum.ServiceType.RegAirWomen || 
                           x.Field<int>("ServiceTypeId") == (int)POR.Enum.ServiceType.VolAirmen || 
                           x.Field<int>("ServiceTypeId") == (int)POR.Enum.ServiceType.VolAirWomen)).CopyToDataTable();
        ...
        public ActionResult Index_Reject(string id, int GSQHID, int FMSID)
        {
            ...
            if (UID != 0)
            {
                ...
                int? PreviousFMSID = PreviousFlowStatusId(GSQHID, UserEstablishmentId, RecordEstablishmentId, UserDivisionId);
                //Get Next FlowStatus User Role Name for Add Successfull Msg
        ...
        public ActionResult Reject(int GSQHID, int FMSID)
        {
            ...
            return PartialView("_RejectCommentGSQ", model);
        }
        [HttpGet]
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                TempData["ErrMsg"] = "Please selecct all search criteria to search the details.";
                            }
                        }
        ...
        public ActionResult ClearFileds(_GSQHeader obj_GSQHeader)
        {
            ...
            ModelState.Clear();
            return RedirectToAction("CreateAllocateMQ", "GSQHeader");
        }
