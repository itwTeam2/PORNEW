...
namespace POR.Models.SecondaryDuty
{
    public class _SecondaryDuty
    {
        [Required(ErrorMessage = "Service No is Required.")]
        public string Snumber { get; set; }
        public string Snumber2 { get; set; }
        [Required(ErrorMessage = "Authority is Required.")]
        public string Authority { get; set; }
        [Required(ErrorMessage = "AreaforResponsibility is Required.")]
        ...
        [Required(ErrorMessage = "WFDate is Required.")]
        public DateTime WFDate { get; set; }
        //public string Authority { get; set; }
        public DateTime CeaseDate { get; set; }
        //public DateTime DutyStatus { get; set; }
        public string ServiceNo { get; set; }
        [Required(ErrorMessage = "Name is Required.")]
        public string FullName { get; set; }
        public string FullName2 { get; set; }
        public string SDSID { get; set; }
        public string SDHID { get; set; }
        public int OicProces { get; set; }
        ...
        [Required(ErrorMessage = "Please Select Duty Location")]
